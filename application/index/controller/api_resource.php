...
return array(
	...
	// 'getAnnounced' => array(
	// 	'query' => array(
	// 		'name' => 'lottery_num as ln',
	// 		'join' => 'left join goods as go on ln.goods_id = go.id',
	// 		'where' => 'go.id = ln.goods_id AND ln.number is not null',
	// 		'fields' => 'go.img,go.sell_price,go.name,go.id,go.market_price,go.sale,go.store_nums,ln.number,ln.lucker,ln.username,ln.time,ln.open_time,ln.order_no',
	// 		// 'limit'=>'10',
	// 		'order'=>'open_time desc',
	// 	)
	// ),
	// //获得幸运者的user_id
	// 'getAnnouncedList' => array(
	// 	'query' => array(
	// 		'name' => 'lottery as l',
	// 		'join' => 'left join lottery_num as ln on l.goods_id = ln.goods_id',
	// 		'where' => 'ln.goods_id = l.goods_id and l.store_nums >= ln.number and ln.number is not null',
	// 		'fields' => 'l.num,l.user_id,l.goods_id,ln.number,l.store_nums',
	// 		// 'limit'=>'9',
	// 		'order'=>'goods_id desc,store_nums asc',
	// 		'group'=>'goods_id',
	// 	)
	// ),
	// //新品列表
	...
	// 		'where' => 'co.commend_id = 1 and go.is_del = 0 AND go.id is not null and go.store_nums > 0',
	// 		'fields' => 'go.img,go.sell_price,go.name,go.id,go.market_price,go.sale,go.store_nums',
	// 		'limit'=>'10',
	// 		'order'=>'sort asc'
	// 	)
	// ),
	...
	// 		'name' => 'commend_goods as co',
	// 		'join' => 'left join goods as go on co.goods_id = go.id',
	// 		'where' => 'co.commend_id = 2 and go.is_del = 0 AND go.id is not null and go.store_nums > 0',
	// 		'fields' => 'go.img,go.sell_price,go.name,go.id,go.market_price,go.sale,go.store_nums',
	// 		// 'limit'=>'10',
	// 		'order'=>'sort asc'
	// 	)
	...
	// 		'name' => 'commend_goods as co',
	// 		'join' => 'left join goods as go on co.goods_id = go.id',
	// 		'where' => 'co.commend_id = 3 and go.is_del = 0 AND go.id is not null and go.store_nums > 0',
	// 		'fields' => 'go.img,go.sell_price,go.name,go.id,go.market_price,go.sale,go.store_nums',
	// 		// 'limit'=>'10',
	// 		'order'=>'sort asc'
	// 	)
	...
	// 		'name' => 'commend_goods as co',
	// 		'join' => 'left join goods as go on co.goods_id = go.id',
	// 		'where' => 'co.commend_id = 4 and go.is_del = 0 AND go.id is not null and go.store_nums > 0',
	// 		'fields' => 'go.img,go.sell_price,go.name,go.id,go.market_price,go.sale,go.store_nums',
	// 		'limit'=>'10',
	// 		'order'=>'sort asc'
	// 	)
	...
	// ),
	// //输出一元夺宝封面
	// 'getCategoryByParentidYiYuan'=>array(
	//     'query'=>array(
	//     	'name'  => 'category',
	//     	'where' => ' parent_id = #parent_id# and visibility = 0 ',
	//     	'order' => ' sort asc',
	//     	'limit' => 1,
	//     )
	// ),
